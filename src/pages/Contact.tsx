        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold text-foreground fade-in-up">
                  ...
                  <div className="space-y-8">
                    {offices.map((office, index) => (
                      <div key={index} className="border-b border-gray-200 last:border-b-0 pb-6 last:pb-0">
                        <h4 className="text-lg font-semibold text-foreground mb-3">{office.city} Office</h4>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass rounded-xl p-6 hover-lift fade-in-up stagger-1">
                  <h4 className="font-semibold text-foreground mb-2">Partnership Process</h4>
                ...
                <div className="glass rounded-xl p-6 hover-lift fade-in-up stagger-2">
                  <h4 className="font-semibold text-foreground mb-2">Service Domains</h4>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="glass rounded-xl p-6 hover-lift fade-in-up stagger-3">
                  <h4 className="font-semibold text-foreground mb-2">Support & Resources</h4>
                  <p className="text-sm text-muted-foreground">
